...
`app()` is what `selfeval` resolves to via the project script entry.
It dispatches to subcommand handlers in `selfeval.cli.commands`.
"""
...
from selfeval._errors import SelfEvalUserError
from selfeval.cli import analyze_commands, commands
from selfeval.cli._help import make_subparser
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Example:\n"
            "  selfeval init my-team\n"
            "  selfeval run evals/experiments/example_pingpong.yaml --no-persist"
        ),
    )
    parser.add_argument("--version", action="version", version=f"selfeval {__version__}")
    parser.add_argument(
        "--db",
        default="./selfeval.sqlite",
        help="Path to SQLite database file (default: ./selfeval.sqlite).",
    )
    ...
    p_init = make_subparser(
        ...
        examples=[
            "selfeval init my-team",
            "selfeval init my-team --name 'My Team' --user alice",
        ],
    )
    ...
    p_ws = make_subparser(
        ...
        examples=["selfeval workspace show ws_01HZZZZZZZZZZZZZZZZZZZZZZZ"],
    )
    ...
    p_ws_show = ws_sub.add_parser(
        ...
        epilog="Example:\n  selfeval workspace show ws_01HZZZZZZZZZZZZZZZZZZZZZZZ",
        formatter_class=argparse.RawDescriptionHelpFormatter,
    )
    ...
    p_exp = make_subparser(
        ...
        examples=[
            "selfeval experiment list ws_01HZZZZZZZZZZZZZZZZZZZZZZZ",
            "selfeval experiment show ws_01HZZZ... exp_01HXXX...",
        ],
    )
    ...
    p_iter = make_subparser(
        ...
        examples=["selfeval iteration list ws_01HZZZ... exp_01HXXX..."],
    )
    ...
    p_iter_list = iter_sub.add_parser(
        ...
        epilog="Example:\n  selfeval iteration list ws_01HZZZ... exp_01HXXX...",
        formatter_class=argparse.RawDescriptionHelpFormatter,
    )
    ...
    p_report = make_subparser(
        ...
        examples=[
            "selfeval report ws_01HZZZ... exp_01HXXX...",
            "selfeval report ws_01HZZZ... exp_01HXXX... --format json",
        ],
    )
    ...
    p_run = make_subparser(
        ...
        examples=[
            "selfeval run evals/experiments/example_pingpong.yaml --no-persist",
            "selfeval run evals/experiments/example_pingpong.yaml --reps 3 --format json",
        ],
    )
    ...
    p_compare = make_subparser(
        ...
        examples=["selfeval compare ws_01HZZZ... iter_01HAAA... iter_01HBBB..."],
    )
    ...
    p_estimate = make_subparser(
        ...
        examples=[
            "selfeval estimate --cases 50 --space-size 8 --reps 3 --cost-per-call 0.01",
        ],
    )
    ...
    p_analyze = make_subparser(
        ...
        examples=[
            "selfeval analyze pull ws_01HZZZ... exp_01HXXX... > bundle.json",
            "selfeval analyze push ws_01HZZZ... exp_01HXXX... < result.json",
        ],
    )
    ...
    p_fm = make_subparser(
        ...
        examples=[
            "selfeval failuremode list ws_01HZZZ... --status candidate",
            "selfeval failuremode promote fm_01HAAA...",
        ],
    )
    ...
    p_fm_list = fm_sub.add_parser(
        ...
        epilog="Example:\n  selfeval failuremode list ws_01HZZZ... --status official",
        formatter_class=argparse.RawDescriptionHelpFormatter,
    )
    ...
    p_fm_promote = fm_sub.add_parser(
        ...
        epilog="Example:\n  selfeval failuremode promote ws_01HZZZ... fm_01HAAA...",
        formatter_class=argparse.RawDescriptionHelpFormatter,
    )
    ...
    p_fm_retire = fm_sub.add_parser(
        ...
        epilog="Example:\n  selfeval failuremode retire ws_01HZZZ... fm_01HAAA...",
        formatter_class=argparse.RawDescriptionHelpFormatter,
    )
    ...
    p_fm_merge = fm_sub.add_parser(
        ...
        epilog="Example:\n  selfeval failuremode merge ws_01HZZZ... fm_dup... --into fm_keep...",
        formatter_class=argparse.RawDescriptionHelpFormatter,
    )
    ...
    p_fm_edit = fm_sub.add_parser(
        ...
        epilog='Example:\n  selfeval failuremode edit ws_01HZZZ... fm_01HAAA... --title "New title"',
        formatter_class=argparse.RawDescriptionHelpFormatter,
    )
    ...
    p_skills = make_subparser(
        ...
        description=(
            "selfeval ships agent skills (e.g. error-analysis) inside the "
            "package. `list` shows them; `path` prints a skill's directory so "
            "an agent or onboarding flow can read or install it."
        ),
        examples=[
            "selfeval skills list",
            "selfeval skills path error-analysis",
        ],
    )
    ...
    p_skills_list = skills_sub.add_parser(
        ...
        description="List every agent skill shipped with this selfeval install.",
        epilog="Example:\n  selfeval skills list",
        formatter_class=argparse.RawDescriptionHelpFormatter,
    )
...
def app(argv: Sequence[str] | None = None) -> int:
    ...
    except SelfEvalUserError as exc:
