...
if TYPE_CHECKING:
    from selfeval.runner.adapters import AdapterRequest, AgentAdapter
    from selfeval.schemas.grader_card import GraderCard
...
def _build_judge_request(context: GraderContext, prompt: str, grader_name: str) -> AdapterRequest:
    from selfeval.runner.adapters import AdapterRequest  # local import to avoid cycle
