...
from selfeval.schemas.trace import GraderResult, Trace

if TYPE_CHECKING:
    from selfeval.storage.interface import ObjectStoreInterface, WorkspaceScope
...
def _record_hypotheses(
    ...
    *,
    ...
    """
    from selfeval.analysis.hypothesis import HypothesisRecord
