...
Every persistent selfeval entity inherits from `BaseEntity`. The workspace
...
class SelfEvalModel(BaseModel):
    """Base model with strict defaults for all selfeval schemas."""
...
class BaseEntity(SelfEvalModel):
