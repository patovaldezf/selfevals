...
from selfeval.schemas.enums import DecisionOutcome, IterationState, ProposerStrategy
from selfeval.schemas.experiment import EditableContract, Experiment
...
class ProposerInputs(SelfEvalModel):
...
class ExecutionInfo(SelfEvalModel):
...
class MetricObservation(SelfEvalModel):
    name: NonEmptyStr
    value: float
    delta_vs_baseline: float | None = None


class IterationMetrics(SelfEvalModel):
...
class IterationDecision(SelfEvalModel):
...
class HumanRationale(SelfEvalModel):
...
class DecisionRationale(SelfEvalModel):
    automated: NonEmptyStr
    human: HumanRationale | None = None


class NextAction(SelfEvalModel):
    kind: NonEmptyStr
