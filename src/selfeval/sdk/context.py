...
The framework side (`selfeval run`) sets SELFEVAL_ITERATION_ID / project
...
Kept dependency-free on purpose — `selfeval.init()` may be called from
...
_PROJECT_ENV = "SELFEVAL_PROJECT"
_ITERATION_ENV = "SELFEVAL_ITERATION_ID"
_RUN_ENV = "SELFEVAL_RUN_ID"
...
_current_tags: ContextVar[RunTags | None] = ContextVar("selfeval_current_tags", default=None)
