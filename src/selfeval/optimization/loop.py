...
from selfeval.schemas.enums import DecisionOutcome, ExperimentState, IterationState
...
class OptimizationLoop:
    ...
    def _maybe_stage_analysis(self, *, iteration: int, aggregate: IterationAggregate) -> None:
        ...
        selfeval stages a bundle's worth of signal — it never runs an agent
        ...
        self._scope.put_entity(
            AnalysisStagingRecord(
                ...
                reason=(
                    ...
                    f"{spec.trigger.threshold:.0%}; run `selfeval analyze pull` "
