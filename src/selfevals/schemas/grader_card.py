...
class HumanReference(SelfEvalsModel):
...
class CalibrationMetrics(SelfEvalsModel):
...
class CalibrationThresholds(SelfEvalsModel):
...
class DegradeBehavior(SelfEvalsModel):
