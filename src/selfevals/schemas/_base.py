...
Every persistent selfevals entity inherits from `BaseEntity`. The workspace
...
class SelfEvalsModel(BaseModel):
    """Base model with strict defaults for all selfevals schemas."""
...
class EntityRef(SelfEvalsModel):
...
class BaseEntity(SelfEvalsModel):
