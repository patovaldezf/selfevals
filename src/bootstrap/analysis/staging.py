"""AnalysisStagingRecord — bootstrap's advisory "this run is worth coding" marker.
...
bootstrap never invokes an agent or an LLM off the back of this. Staging is a
...
from bootstrap.schemas._base import BaseEntity, NonEmptyStr
