"""Locate the agent skills bundled with the bootstrap SDK.

Skills ship inside the installed package under `bootstrap/.agents/skills/<name>/`
...
bootstrap owns the *method* encoded in each skill; the agent supplies the
...
_PACKAGE_ANCHOR = "bootstrap"
_SKILLS_SUBDIR = (".agents", "skills")


def _skills_root() -> Traversable:
    """The `bootstrap/.agents/skills` directory inside the installed package."""
