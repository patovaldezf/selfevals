...
from bootstrap.runner.adapters import AdapterError, AdapterRequest
from bootstrap.runner.sandbox import SandboxPolicy
from bootstrap.schemas.enums import StopReason, ToolCallStatus
...
if TYPE_CHECKING:
    from bootstrap.runner.adapters import AdapterResponse, AgentAdapter
...
class Executor:
    def __init__(
        ...
        *,
        ...
        workspace_id: str,
        framework_version: str = "bootstrap/0.0.4",
