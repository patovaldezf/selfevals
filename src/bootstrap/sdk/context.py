...
The framework side (`bootstrap run`) sets BOOTSTRAP_ITERATION_ID / project
...
Kept dependency-free on purpose — `bootstrap.init()` may be called from
...
_PROJECT_ENV = "BOOTSTRAP_PROJECT"
_ITERATION_ENV = "BOOTSTRAP_ITERATION_ID"
_RUN_ENV = "BOOTSTRAP_RUN_ID"
...
_current_tags: ContextVar[RunTags | None] = ContextVar("bootstrap_current_tags", default=None)
